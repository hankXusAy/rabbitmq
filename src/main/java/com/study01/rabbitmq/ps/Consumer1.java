...
public class Consumer1 {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        //声明队列
        channel.queueDeclare(Product.QUEUE_NAME1,true,false,false,null);
        //绑定队列到交换机
        channel.queueBind(Product.QUEUE_NAME1,Product.FANOUT_EXCHANGE,"");
         ...
         * 参数3:消费者
         */
        channel.basicConsume(Product.QUEUE_NAME1,true,defaultConsumer);
    }
}
